...
export default function LandingPage() {
 ...
 <div>
			...
			<div className="container">
				<div className="row">
					<div className="col-xs-12 text-right">
						<p className="site">www.yourdomainname.com</p>
			...
			<div className="container">
				<div className="row">
					<div className="col-xs-2">
						<div id="fh5co-logo"><a href="index.html"><i className="icon-study"></i>Educ<span>.</span></a></div>
					</div>
	...
	<div id="fh5co-counter" className="fh5co-counters" style={{backgroundImage: 'url(images/img_bg_4.jpg)'}} data-stellar-background-ratio="0.5">
				...
				<div className="col-md-10 col-md-offset-1">
					<div className="row">
						<div className="col-md-3 col-sm-6 text-center animate-box">
							...
							<span className="fh5co-counter js-counter" data-from="0" data-to="3297" data-speed="5000" data-refresh-interval="50"></span>
							<span className="fh5co-counter-label">Foreign Followers</span>
						</div>
						<div className="col-md-3 col-sm-6 text-center animate-box">
							<span className="icon"><i className="icon-study"></i></span>
							<span className="fh5co-counter js-counter" data-from="0" data-to="3700" data-speed="5000" data-refresh-interval="50"></span>
							<span className="fh5co-counter-label">Students Enrolled</span>
						</div>
						<div className="col-md-3 col-sm-6 text-center animate-box">
							<span className="icon"><i className="icon-bulb"></i></span>
							<span className="fh5co-counter js-counter" data-from="0" data-to="5034" data-speed="5000" data-refresh-interval="50"></span>
							<span className="fh5co-counter-label">classNamees Complete</span>
						</div>
						<div className="col-md-3 col-sm-6 text-center animate-box">
							<span className="icon"><i className="icon-head"></i></span>
							<span className="fh5co-counter js-counter" data-from="0" data-to="1080" data-speed="5000" data-refresh-interval="50"></span>
			...
			<div className="row">
				<div className="col-md-6 animate-box">
					<div className="course">
						<a href="#" className="course-img" style={{backgroundImage: 'url(images/project-1.jpg)'}}>
						</a>
						<div className="desc">
							<h3><a href="#">Web Master</a></h3>
							<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
							<span><a href="#" className="btn btn-primary btn-sm btn-course">Take A Course</a></span>
						</div>
					</div>
				</div>
				<div className="col-md-6 animate-box">
					<div className="course">
						<a href="#" className="course-img" style={{backgroundImage: 'url(images/project-2.jpg)'}}>
						</a>
						<div className="desc">
				...
				<div className="col-md-6 animate-box">
					<div className="course">
						<a href="#" className="course-img" style={{backgroundImage: 'url(images/project-3.jpg)'}}>
						</a>
						<div className="desc">
							<h3><a href="#">Science &amp; Technology</a></h3>
							<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
				...
				<div className="col-md-6 animate-box">
					<div className="course">
						<a href="#" className="course-img" style={{backgroundImage: 'url(images/project-4.jpg)'}}>
						</a>
						<div className="desc">
							<h3><a href="#">Health &amp; Psychology</a></h3>
							<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
	...
	<div id="fh5co-testimonial" style={{backgroundImage: 'url(images/school.jpg)'}}>
		<div className="overlay"></div>
		<div className="container">
			<div className="row animate-box">
				<div className="col-md-6 col-md-offset-3 text-center fh5co-heading">
						...
						<div className="owl-carousel owl-carousel-fullwidth">
							<div className="item">
								<div className="testimony-slide active text-center">
									<div className="user" style={{backgroundImage: 'url(images/person1.jpg)'}}></div>
							...
							<div className="item">
								<div className="testimony-slide active text-center">
									<div className="user"style={{backgroundImage: 'url(images/person2.jpg)'}}></div>
			...
			<div className="row row-padded-mb">
				<div className="col-md-4 animate-box">
					<div className="fh5co-event">
						<div className="date text-center"><span>15<br/>Mar.</span></div>
			...
			<div className="row">
				<div className="col-lg-4 col-md-4">
					<div className="fh5co-blog animate-box">
						<a href="#" className="blog-img-holder" style={{backgroundImage: 'url(images/person1.jpg)'}} ></a>
						<div className="blog-text">
							<h3><a href="#">Healty Lifestyle &amp; Living</a></h3>
							<span className="posted_on">March. 15th</span>
							<span className="comment"><a href="">21<i className="icon-speech-bubble"></i></a></span>
							<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
						</div> 
					</div>
				</div>
				<div className="col-lg-4 col-md-4">
					<div className="fh5co-blog animate-box">
						<a href="#" className="blog-img-holder" style={{backgroundImage: 'url(images/project-2.jpg)'}}></a>
						<div className="blog-text">
							<h3><a href="#">Healty Lifestyle &amp; Living</a></h3>
							<span className="posted_on">March. 15th</span>
							<span className="comment"><a href="">21<i className="icon-speech-bubble"></i></a></span>
				...
				<div className="col-lg-4 col-md-4">
					<div className="fh5co-blog animate-box">
						<a href="#" className="blog-img-holder" style={{backgroundImage: 'url(images/project-3.jpg)'}}></a>
						<div className="blog-text">
							<h3><a href="#">Healty Lifestyle &amp; Living</a></h3>
							<span className="posted_on">March. 15th</span>
							<span className="comment"><a href="">21<i className="icon-speech-bubble"></i></a></span>
	...
	<div id="fh5co-register" style={{backgroundImage: 'url(images/img_bg_2.jpg)'}}>
		<div className="overlay"></div>
		<div className="row">
			<div className="col-md-8 col-md-offset-2 animate-box">
				<div className="date-counter text-center">
					...
					<p><a href="#" className="btn btn-primary btn-lg btn-reg">Register Now!</a></p>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="fh5co-gallery" className="fh5co-bg-section">
		...
		<div className="row">
			<div className="col-md-3 col-padded">
				<a href="#" className="gallery" style={{backgroundImage: 'url(images/project-5.jpg)'}}></a>
			</div>
			<div className="col-md-3 col-padded">
				<a href="#" className="gallery" style={{backgroundImage: 'url(images/project-2.jpg)'}}></a>
			</div>
			<div className="col-md-3 col-padded">
				<a href="#" className="gallery" style={{backgroundImage: 'url(images/project-3.jpg)'}}></a>
			</div>
			<div className="col-md-3 col-padded">
				<a href="#" className="gallery" style={{backgroundImage: "url(images/project-4.jpg)"}}></a>
			</div>
		</div>
	</div>
			...
			<div className="row copyright">
				<div className="col-md-12 text-center">
					<p>
						...
						<small className="block">Designed by <a href="http://freehtml5.co/" target="_blank">FreeHTML5.co</a> Demo Images: <a href="http://unsplash.co/" target="_blank">Unsplash</a> &amp; <a href="https://www.pexels.com/" target="_blank">Pexels</a></small>
					</p>
				</div>
			</div>
