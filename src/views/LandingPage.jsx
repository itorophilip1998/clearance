  ...
  return (
    <>
          ...
          <ul className="slides">
            <li style={{ backgroundImage: "url(images/big1.jpg)" }}>
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-8 mx-auto col-md-offset-2 text-center slider-text">
      ...
      <div id="fh5co-course-categories">
        <div className="container">
          <div className="row animate-box">
            <div className="col-md-6 col-md-offset-3 mx-auto text-center fh5co-heading">
      ...
      <div id="fh5co-course">
        <div className="container">
          <div className="row animate-box">
            <div className="col-md-6 mx-auto col-md-offset-3 text-center fh5co-heading">
              <h2>Our Course</h2>
              <p>
                Dignissimos asperiores vitae velit veniam totam fuga molestias
                accusamus alias autem provident. Odit ab aliquam dolor eius.
            ...
            <div className="col-md-6 animate-box">
              <div className="course">
                <a
                  ...
                  style={{ backgroundImage: "url(images/bga.jpg)" }}
                ></a>
                <div className="desc">
                  <h3>
                    <a href="#">Web Master</a>
            ...
            <div className="col-md-6 animate-box">
              <div className="course">
                <a
                  href="#"
                  className="course-img"
                  style={{ backgroundImage: "url(images/bgb.jpg)" }}
                ></a>
                <div className="desc">
                  <h3>
            ...
            <div className="col-md-6 animate-box">
              <div className="course">
                <a
                  href="#"
                  className="course-img"
                  style={{ backgroundImage: "url(images/bgd.jpg)" }}
                ></a>
                <div className="desc">
                  <h3>
                    <a href="#">Health &amp; Psychology</a>
